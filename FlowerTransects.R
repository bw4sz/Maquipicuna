...
Elev<-lapply(list.files("Thesis/Maquipucuna_SantaLucia/Data2013/Shapefiles/AnushaGPS.shp",pattern=".shp",full.names=T),readShapePoints)
...
fl.elev<-merge(full.fl,Elev,by.x="GPS_ID",by.y="name")
